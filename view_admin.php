         ...
         require_once("_Assets/include/connection.php");
            ...
            while($rs=$result->fetch_array()){
              $id =  htmlentities($rs['id']);
               ...
               $admin=htmlentities($rs['admin_user']);
               $pass=htmlentities($rs['admin_password']);
               $status=htmlentities($rs['admin_status']);
          ...
          ?>         
           <tr>
               ...
               <td align='center'><a rel="tooltip"  title="Edit" id="e<?php echo $id; ?>" href="#edit<?php echo $id; ?>" data-toggle="modal"><i class="fas fa-user-edit"  data-toggle="modal" data-target="#edit"></i></a> | <a href="delete_admin.php?id=<?php echo htmlentities($rs['id']); ?>"><i class='far fa-trash-alt'></i></a>
