...
<body class="grey lighten-3">
 ...
 <div id="loader"></div>
  <main class="pt-5 mx-lg-5">
    ...
    <a href="view_archiveadmin.php"><img src="_Assets/img/user-trash-full-128.png" class="imgs" width="40px" height="40px" title="View Archive" style="float: right;"></a>
    </div>
   <hr>
 <div class="col-md-12">
...
<tbody>
    ...
    <tr>
      ...
      <?php 
          error_reporting(0);
           require_once("_Assets/include/connection.php");
            $getID = $conn->real_escape_string($_GET['eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ']);
            $query = $conn->query("SELECT *, a.type as sub, a.type as types FROM `upload_adminfiles` a LEFT JOIN `folder_content` b ON a.LOGIN_ID = b.fol_id WHERE a.ADMIN_STATUS = 'Admin' AND a.LOGIN_ID = '$getID'") or die (mysqli_error($conn));
          if($query->num_rows === 0) echo'<div class="alert alert-danger" role="alert">No Record Found!!!</div>';
            while($file=$query->fetch_array()){
               ...
               if($type == "file"){
                  ...
                  $var =  '<a href="subfolder_superadmin1.php?eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ='.$id.'"><img src="_Assets/img/floder-close-128.png" width="30px" height="25px" title="View File">&nbsp;'.substr($foldername,11).'</a>  &nbsp;<i class="fas fa-file-medical sub_click" style="color:#007bff" title="Add new file" data-id="'.$id.'"></i> | <i class="fas fa-folder-plus sub_click2" style="color:#fb3" title="Add new subfolder" data-idx="'.$id.'"></i>';
               } 
               if($type == "file"){
                      $var1 =  '<a href="download.php?f='.$foldername.''.$name.'"><img src="_Assets/img/search-download-128.png" width="30px" height="30px" title="View And Download File" download></a> | <a href="remove_adminfile.php?ID='.$id.'"><img src="_Assets/img/-_Trash-Can-Delete-Remove--128.png" width="30px" height="30px" title="Remove File"></a>';
                   }else{
                      $var1 =  '';
             }
