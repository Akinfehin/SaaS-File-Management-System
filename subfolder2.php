                                 ...
                                 <?php 
                                  ...
                                  if($query->num_rows === 0) echo'<div class="alert alert-danger" role="alert">No Record Found!!!</div>';
                                    while($file=$query->fetch_array()){
                                     ...
                                     if($type == "sub_file2"){
                                          $var3 =  '<a href="download.php?f='.$foldername.''.$name.'"><img src="_Assets/img/file-document-download-128.png" width="30px" height="30px" title="View And Download File"></a>';
                                           // | <a href="remove2.php?ID='.$id.'"><img src="_Assets/img/trash-128.png" width="30px" height="30px" title="Remove File"></a>
                                       }else{
                                          $var3 =  '';
                                       }
