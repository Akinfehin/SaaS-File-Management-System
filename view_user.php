     ...
     <?php
         require_once("_Assets/include/connection.php");
            ...
            while($rs=$result->fetch_array()){
               ...
               $fname=htmlentities($rs['name']);
               $admin=htmlentities($rs['email_address']);
               $pass=htmlentities($rs['user_password']);
               $status=htmlentities($rs['user_status']);
          ...
          ?>       
           ...
           <tr>
               ...
               <td align='center'><a rel="tooltip"  title="Edit" id="e<?php echo $id; ?>" href="#edits<?php echo $id; ?>" data-toggle="modal"><i class="fas fa-user-edit"  data-toggle="modal" data-target="#edits"></i></a> | <a href="delete_user.php?id=<?php echo htmlentities($rs['id']); ?>"><i class='far fa-trash-alt'></i></a></td>
