...
<tbody>  
  ...
  <?php 
   ...
   $query = mysqli_query($conn,"SELECT DISTINCT ID,FOLDERSELECT,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,VARIABLE FROM trash group by NAME DESC") or die (mysqli_error($conn));
   if($query->num_rows === 0) echo'<div class="alert alert-danger" role="alert">No Record Found!!!</div>';
      ...
      ?>
       ...
       <td><?php echo $time; ?></td>
       <td width="15%"> <a href='restore.php?ID=<?php echo $id; ?>'><img src="_Assets/img/020_072_refresh_reload_folder_files_storage-128.png" width="30px" height="30px" title="Restore File"></a></td>
    </tr>
<?php } ?>
</tbody>
</table>
