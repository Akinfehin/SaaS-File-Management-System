...
<body class="grey lighten-3">
 ...
 <div id="loader"></div>
  <main class="pt-5 mx-lg-5">
    ...
    <a href="view_archive.php"><button type="button" class="btn btn-warning" style="float: right;"><i class="far fa-trash-alt"></i> Archive</button></a>
    </div>
  <hr> 
 <div class="col-md-12">
 ...
 <tr>
  <?php 
       ...
       require_once("_Assets/include/connection.php");
        ...
        $query = $conn->query(" SELECT *  FROM folder_content order by fol_id DESC") or die (mysqli_error($conn));
        ...
        while($file=$query->fetch_array()){
           ...
           $dates = $file['date_created'];

        ?>

        <td width="30%"><img src="_Assets/img/folder-128.png" width="30px" height="30px" title="View File"><a href="subfolder_superadmin.php?eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ=<?php echo  $idx; ?>"> <?php echo  substr($var1,11); ?></a>&nbsp;&nbsp;<i class="fas fa-folder-plus sub_click" style="color:green" title="Add new subfolder" data-id="<?php echo $idx ;?>"></i>
