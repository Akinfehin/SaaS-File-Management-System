            ...
            <div class="card-body">
              <?php
                       ...
                       require_once("_Assets/include/connection.php");
                             ...
                             $sql ="SELECT *,count(a.LOGIN_ID) as count, a.EMAIL as EMAIL FROM upload_files a LEFT JOIN upload_files1 b ON a.LOGIN_ID = b.GET_ID LEFT JOIN upload_files2 c ON a.LOGIN_ID = c.GET_ID ";
                             $result = $conn->query($sql);
                             $chart_data="";
                             while ($row = $result->fetch_array()) { 
                     
                                $name[]  = htmlentities($row['EMAIL']);
                                $counts[] = htmlentities($row['count']);
                            }
