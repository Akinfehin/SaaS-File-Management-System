...
<body class="grey lighten-3">
 ...
 <div id="loader"></div>
  ...
  <a href="view_archiveadmin1.php"><img src="_Assets/img/user-trash-full-128.png" class="imgs" width="40px" height="40px" title="View Archive" style="float: right;"></a>
    </div>
   <hr>
 <div class="col-md-12">
...
<?php 
        error_reporting(0);
         require_once("_Assets/include/connection.php");
          ...
          $query = $conn->query("SELECT *,b.ID as IDS  FROM upload_adminfiles a INNER JOIN upload_adminfiles1 b ON a.ID = b.GET_ID WHERE GET_ID = '$getID'") or die (mysqli_error($conn));
        if($query->num_rows === 0) echo'<div class="alert alert-danger" role="alert">No Record Found!!!</div>';
          while($file=$query->fetch_array()){
             ...
             if($type == "sub_file1"){
                ...
                $var =  '<a href="subfolder_superadmin2.php?SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c='.$idx.'""><img src="_Assets/img/floder-close-128.png" width="30px" height="25px" title="View File">&nbsp;'.substr($foldername,11).'</a> &nbsp;<i class="fas fa-file-medical sub_click" style="color:#007bff" title="Add new file" data-id2="'.$idx.'"></i>';
             }
              if($type == "sub_file1"){
                    $var2 =  '<a href="download.php?f='.$foldername.''.$name.'"><img src="_Assets/img/search-download-128.png" width="30px" height="30px" title="View And Download File"></a> | <a href="remove_adminfile1.php?ID='.$id.'"><img src="_Assets/img/-_Trash-Can-Delete-Remove--128.png" width="30px" height="30px" title="Remove File"></a>';
                 }else{
                    $var2 =  '';
                 }
