      ...
      if($query->num_rows === 0) echo'<div class="alert alert-danger" role="alert">No Record Found!!!</div>';
        while($file=$query->fetch_array()){
           ...
           if($type == "sub_file1"){
              ...
              $var =  '<a href="subfolder2.php?SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c='.$idx.'""><img src="_Assets/img/floder-close-128.png" width="30px" height="25px" title="View File">&nbsp;'.substr($foldername,12).'</a>';
           }
          if($type == "sub_file1"){
                    $var2 =  '<a href="download.php?f='.$foldername.''.$name.'"><img src="_Assets/img/search-download-128.png" width="30px" height="30px" title="View And Download File"></a> | <a href="remove1.php?ID='.$id.'"><img src="_Assets/img/-_Trash-Can-Delete-Remove--128.png" width="30px" height="30px" title="Remove File"></a> | <a href="#" data-toggle="modal" data-target="#modal_comment2'.$id.'"><img src="_Assets/img/Comment-add.webp" width="30px" height="30px" title="Add Comment"></a>';
                 }else{
                    $var2 =  '';
                 }
       ...
       <?php include 'modal_comment2.php';?>
           ...
           require_once("_Assets/include/connection.php");
             ...
             if(isset($_POST['edit_comment2'])){
               ...
               $ID = $conn->real_escape_string($_POST['ID']);
                ...
                $conn->query("UPDATE upload_files1 SET COMMENT = '$COMMENT' WHERE ID = '$ID'") or die(mysqli_error($conn));
