<?php
    ...
    mkdir("{$destination}", 0777); 
      ...
      $emp = "Employee";
       $sql = $conn->query("INSERT INTO `upload_files1`(`NAME`, `SIZE`, `DOWNLOAD`, `TIMERS`, `ADMIN_STATUS`, `EMAIL`, `VARIABLE`,  `type`,  `LOGIN_ID`, `GET_ID`)  VALUES ('$folder_name', '$size', '$download', '$time',  '$status', '$name', '$destination',  '$folder', 'sub_$ID','$ID')")  or die (mysqli_error($conn));
